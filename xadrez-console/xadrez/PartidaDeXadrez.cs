    ...
    class PartidaDeXadrez
    {
        ...
        public Peca executaMovimento(Posicao origem, Posicao destino)
        {
            ...
            if(p is Rei && destino.coluna == origem.coluna + 2)
            {
                ...
                Peca torreMovida = tab.retirarPeca(origemTorre);
                torreMovida.incrementarQdeMovimentos();
                tab.colocarPeca(torreMovida, destinoTorre);
        ...
        public void desfazMovimento(Posicao origem, Posicao destino, Peca pecaCapturada)
        {
            ...
            if(p is Rei && destino.coluna == origem.coluna + 2)
            {
                Posicao origemTorre = new Posicao(origem.linha, origem.coluna + 3);
                Posicao destinoTorre = new Posicao(origem.linha, origem.coluna + 1);
                Peca torreMovida = tab.retirarPeca(destinoTorre);
                torreMovida.decrementarQdeMovimentos();
                tab.colocarPeca(torreMovida, origemTorre);
            }
        ...
        public void realizaJogada(Posicao origem, Posicao destino)
        {
            ...
            if(p is Peao)
            {
                if ((p.cor == Cor.Branca && destino.linha == 0) || (p.cor == Cor.Preta && destino.linha == 7))
                {
                    ...
                    pecas.Remove(p);
                    System.Console.WriteLine("Promover para: Rainha - 1 | Torre - 2 | Cavalo - 3 | Bispo - 4");
                    int promovido = int.Parse(Console.ReadLine());
                    switch(promovido)
                    {
                        case 1:
        ...
        private void colocarPecas()
        {
            ...
            colocarNovaPeca('c', 6, new Peao(Cor.Branca, tab, this));
